...
extern "C"
{
	...
	extern void playBackgroundMusicXPFJNI(const char *path, bool isLoop, const char* szXPFPath, unsigned int dwSeek, unsigned int dwSize);
	extern unsigned int playEffectXPFJNI(const char* path, bool bLoop, const char* szXPFPath, unsigned int dwSeek, unsigned int dwSize);
}
